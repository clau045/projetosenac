...
public class VendaControle {
	...
	public ModelAndView cadastrar(Venda venda, ItemVenda itemVenda) { 
		...
		mv.addObject("listaItemVenda", itemVendaRepositorio.buscaporVenda(venda.getId()));
	...
	public ModelAndView salvar(String acao, Venda venda, ItemVenda itemVenda, BindingResult result) { 
		...
		if(acao.equals("itens")) {
			...
			venda.setQuantidadetTotal( venda.getQuantidadetTotal() + itemVenda.getQuantidade() );
	...
	public ModelAndView editar(@PathVariable("id") Long id) {
		...
		this.listaItemVenda = itemVendaRepositorio.buscaporVenda(venda.get().getId()); //carregar os itens da venda
	...
	public ModelAndView remover(@PathVariable("id") Long id) {
		...
		this.listaItemVenda = itemVendaRepositorio.buscaporVenda(venda.get().getId());
	...
	public ModelAndView removerItemVenda(@PathVariable("id") Long id) {
		...
		i.getVenda().setQuantidadetTotal( i.getVenda().getQuantidadetTotal() - i.getQuantidade() );
